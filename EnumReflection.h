...
namespace EnumReflection
{
    ...
    /**
     * @brief counts enum elements
     *   
     * @tparam E - enum which elements you want to count
     * @return the count of elements in given enum
     */
    template <class E>
    ...
    /**
     * @brief check if given type is scoped enum (enum class)
     * 
     * @tparam T - type to be checked
     * @return true whether given type is scoped enum
     * false otherwise
     */
    ...
    /**
     * @brief check if given enum is normalized (its values begins from 0 and it has no gaps)
     * 
     * @tparam E - enum to be checked
     * @return true whether given enum is normalized
     * flase otherwise
     */
    template <class E>
